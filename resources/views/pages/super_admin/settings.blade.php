               ...
               <fieldset>
                   ...
                   @foreach($class_types as $ct)
                    <div class="form-group row">
                        ...
                        <div class="col-lg-9">
                            <input class="form-control" name="next_term_fees_{{ strtolower($ct->code) }}" placeholder="{{ $ct->name }}" type="text">
                   ...
                   @endforeach
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-9">
                            {{-- {{ $s['logo'] }} --}}
                            <div class="mb-3">
                                {{-- <img style="width: 100px" height="100px" src="{{ asset('storage/uploads/logo.png') }}" alt=""> --}}
