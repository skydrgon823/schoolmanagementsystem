            ...
            <div class="tab-content">
                <div class="tab-pane fade show active" id="change-pass">
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            <div class="col-md-12">
                                <h5 class="text-success">The reset code has been sent to your phone number. Use it below to change your password</h5>
                            </div>
                            <div class="col-md-12">
                                <form method="post" action="{{ route('my_account.change_pass') }}">
                                    ...
                                    <div class="form-group row">
                                        <label for="reset_code" class="col-lg-3 col-form-label font-weight-semibold">Reset Code <span class="text-danger">*</span></label>
                                        <div class="col-lg-9">
                                            <input id="reset_code" name="reset_code"  required class="form-control" >
                                        </div>
                                    </div>
