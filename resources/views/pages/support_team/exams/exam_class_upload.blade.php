        ...
        <form action="{{ route('exam_class_upload_mark') }}" method="post">
            ...
            <div class="row">
                <div class="col-6">
                    ...
                    {{-- <input type="text" name="exam_class_upload_exam" class="form-control" id="exam_class_upload_exam" placeholder="{{ $exam->name }}"> --}}
                    <select class="select form-control" id="exam_class_upload_exam" name="exam_class_upload_exam" data-fouc data-placeholder="Select ....">
                        <option value=""></option>
                ...
                <div class="col-6">
                    ...
                    <input type="number" name="exam_class_upload_max" class="form-control" id="exam_class_upload_max" placeholder="'out of' value e.g. 30">
                </div>
            </div>
            <br>
            @if ($subject->status_x>0 || $subject->status_y>0 || $subject->status_z>0)
                <div class="row">
                    <div class="col-12">
                        <div class="form-group">
                            <label for="exam-class-subject">Subject Paper</label>
                            <select class="select form-control" id="exam-class-subject" name="exam_class_subject" data-fouc data-placeholder="Subject Paper..." required>
                                <option value=""></option>
                                @if ($subject->status_x>0)
                                    <option value="1">Paper 1</option>
                                @endif
                                @if ($subject->status_y>0)
                                    <option value="2">Paper 2</option>
                                @endif
                                @if ($subject->status_z>0)
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="input-group">
                                        <input type="number" class="form-control" name="mark{{ $i }}" onchange="validate({{ $i }}, this)">
            ...
            <div class="row align-items-center ml-1">
                ...
                <div class="col-6 text-right pt-2">
                    ...
                    <button type="submit" class="btn btn-primary">Upload Subject Results</button>
                </div>
            </div>
        </form>
    </div>
