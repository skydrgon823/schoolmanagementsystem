    ...
    <div class="card">
        ...
        <div class="card-body">
            <ul class="nav nav-tabs nav-tabs-highlight">
                <li class="nav-item"><a href="#change-pass" class="nav-link active" data-toggle="tab">School Profile</a></li>
                <li class="nav-item"><a href="#change-pass" class="nav-link active" data-toggle="tab">School Options</a></li>
                <li class="nav-item"><a href="#change-pass" class="nav-link active" data-toggle="tab">User Roles</a></li>
                @if(Qs::userIsPTA())
